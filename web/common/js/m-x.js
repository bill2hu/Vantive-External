...
function xPosition(e,p) {
  if(!(e=xGetElementById(e))) return 0;
  if(e.style && xDef(e.style.position)) {
    if(arguments.length>1) e.style.position=p;
    else p=e.style.position;
  }
  else if(xDef(e.position)) {
    if(arguments.length>1) e.position=p;
    else p=e.position;
  }
  return p;
}
function xVisibility(e,uV) {
  if(!(e=xGetElementById(e))) return 0;
  if(e.style && xDef(e.style.visibility)) {
    if(arguments.length>1) e.style.visibility=uV;
    else uV=e.style.visibility;
  }
  else if(xDef(e.visibility)) {
    if(arguments.length>1) e.visibility=uV;
    else uV=e.visibility;
  }
  return uV;
}
